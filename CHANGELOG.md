...
*   **统一UI风格**：
    *   调整了设置面板内列表项的背景色，使其与整体UI的白色背景保持一致，增强了视觉的统一性和简洁性。
    *   优化了“编辑标签”按钮的交互效果，现在鼠标悬停时会变为主题蓝色，以更好地指示其可交互性。
    *   统一了删除按钮的交互样式，确保其在不同功能模块下的视觉和操作体验一致。
...
*   **优化悬浮窗UI**：重新设计了用户标记悬浮窗的UI，使其在视觉风格上与脚本整体保持和谐统一，并提升了布局的清晰度和美观度。
